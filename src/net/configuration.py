...
#rcnn
CFG.TRAIN.RCNN_BATCH_SIZE   = 512
CFG.TRAIN.RCNN_FG_FRACTION  = 0.25
CFG.TRAIN.RCNN_BG_THRESH_HI = 0.5 # 0.6
CFG.TRAIN.RCNN_BG_THRESH_LO = 0.1
CFG.TRAIN.RCNN_FG_THRESH_LO = 0.5 # 0.3
...
CFG.TEST.RPN_NMS_POST_TOPN = 300
